...
class KingOfTokyo extends Table {
    ...
    */
    protected function setupNewGame( $players, $options = []) {
        ...
        $this->cards->moveCard( $this->getCardFromDb(array_values($this->cards->getCardsOfType(44))[0])->id, 'hand', 2343493);
        $this->cards->moveCard( $this->getCardFromDb(array_values($this->cards->getCardsOfType(22))[0])->id, 'hand', 2343493);
