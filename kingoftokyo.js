...
var PlayerTable = /** @class */ (function () {
    function PlayerTable(game, player, playerWithGoldenScarab, evolutionCardsWithSingleState) {
        ...
        this.cards.onSelectionChange = function (_, card) { return _this.game.onVisibleCardClick(_this.cards, card, _this.playerId); };
        ...
        if (game.isPowerUpExpansion()) {
            ...
            this.cards.onSelectionChange = function (_, card) { return _this.game.onVisibleCardClick(_this.reservedCards, card, _this.playerId); };
...
var TableCenter = /** @class */ (function () {
    function TableCenter(game, players, visibleCards, topDeckCardBackType, deckCardsCount, wickednessTiles, tokyoTowerLevels, curseCard, hiddenCurseCardCount, visibleCurseCardCount) {
        var _this = this;
        this.game = game;
    ...
    TableCenter.prototype.createVisibleCards = function (visibleCards, topDeckCardBackType, deckCardsCount) {
        var _this = this;
        this.deck = new HiddenDeck(this.game.cardsManager, document.getElementById('deck'), __assign(__assign({}, DECK_SETTINGS), { cardNumber: deckCardsCount, shadowDirection: 'top-right' }));
    ...
    TableCenter.prototype.createCurseCard = function (curseCard, hiddenCurseCardCount, visibleCurseCardCount) {
        dojo.place("<div id=\"curse-wrapper\">\n            <div id=\"curse-deck\"></div>\n            <div id=\"curse-card\"></div>\n        </div>", 'table-curse-cards');
        this.curseCard = new VisibleDeck(this.game.curseCardsManager, document.getElementById('curse-card'), __assign(__assign({}, DECK_SETTINGS), { cardNumber: visibleCurseCardCount }));
        this.curseCard.addCard(curseCard);
        this.curseDeck = new HiddenDeck(this.game.curseCardsManager, document.getElementById('curse-deck'), __assign(__assign({}, DECK_SETTINGS), { cardNumber: hiddenCurseCardCount }));
    ...
    */
    ...
    KingOfTokyo.prototype.onEnteringPickEvolutionForDeck = function (args) {
        ...
        if (!document.getElementById('choose-evolution-in')) {
            ...
            this.choseEvolutionInStock.onSelectionChange = function (_, card) { return _this.pickEvolutionForDeck(card.id); };
    ...
    */
    ...
    KingOfTokyo.prototype.notif_buyCard = function (notif) {
        ...
        if (notif.args.discardCard) { // initial card
            ...
            this.getPlayerTable(notif.args.playerId).cards.addCard(card, { fromStock: fromStock });
        }
    ...
    KingOfTokyo.prototype.notif_setCardTokens = function (notif) {
        this.cardsManager.placeTokensOnCard(notif.args.card, notif.args.playerId);
    };
    ...
    KingOfTokyo.prototype.notif_exchangeCard = function (notif) {
        var previousOwnerCards = this.getPlayerTable(notif.args.previousOwner).cards;
        var playerCards = this.getPlayerTable(notif.args.playerId).cards;
