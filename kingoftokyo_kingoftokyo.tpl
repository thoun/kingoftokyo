...
<audio id="audiosrc_kot-punch" src="{GAMETHEMEURL}img/punch.mp3" preload="none" autobuffer></audio>
<audio id="audiosrc_o_kot-punch" src="{GAMETHEMEURL}img/punch.ogg" preload="none" autobuffer></audio>
