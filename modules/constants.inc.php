...
define('RESURRECTION_OF_OSIRIS_CURSE_CARD', 16); // TODO TOCHECK can we remove tokens in or out of Tokyo
define('FORBIDDEN_LIBRARY_CURSE_CARD', 17);
define('CONFUSED_SENSES_CURSE_CARD', 18); // TODOAN test permanent
