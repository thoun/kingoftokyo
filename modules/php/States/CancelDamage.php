...
class CancelDamage extends GameState {
    ...
    function actUseInvincibleEvolution(int $evolutionType, int $currentPlayerId) {
        ...
        $this->game->powerUpExpansion->evolutionCards->items->moveItem($card, ['table', $currentPlayerId]);
    ...
    function actUseCandyEvolution(int $currentPlayerId) {
        ...
        $this->game->powerUpExpansion->evolutionCards->items->moveItem($evolution, ['table', $currentPlayerId]);
        ...
        $this->game->powerUpExpansion->evolutionCards->items->moveItem($evolution, ['hand', $toPlayerId]);
        $message = clienttranslate('${player_name2} use ${card_name} to avoid damages and gives ${card_name} to ${player_name}');
