...
define('ST_AFTER_RESOLVE_DAMAGE', 68); // !
...
define('MINDBUG_EXPANSION_OPTION', 114);
define('ORIGINS_EXCLUSIVE_CARDS_OPTION', 130);
define('MINDBUG_CARDS_OPTION', 131);
...
define('UNSTOPPABLE_HYDRA_EVOLUTION_1', 611);
define('UNSTOPPABLE_HYDRA_EVOLUTION_2', 612);
define('ENERGY_INFUSED_MONSTER_EVOLUTION', 613);
define('THREE_TIMES_AS_STURDY_EVOLUTION', 614);
define('SCARY_FACE_EVOLUTION', 615);
define('THREE_TIMES_AS_STRONG_EVOLUTION', 616);
define('THINKING_FACE_EVOLUTION', 617);
define('HUNGRY_FACE_EVOLUTION', 618);
// evolutions : MasterMindbug
define('MINDBUG_ACQUISITION_EVOLUTION', 621);
define('INTERGALACTIC_GENIUS_EVOLUTION', 622);
define('SUPERIOR_BRAIN_EVOLUTION', 623);
define('INTERDIMENSIONAL_PORTAL_EVOLUTION', 624);
define('HELPFUL_MINDBUG_EVOLUTION', 625);
define('MINDBUGS_OVERLORD_EVOLUTION', 626);
define('MIND_CONTROL_EVOLUTION', 627);
define('NEUTRALIZING_LOOK_EVOLUTION', 628);
// evolutions : Sharky Crab-dog Mummypus-Zilla
define('SHARK_ATTACK_EVOLUTION', 631);
define('ENERGY_DEVOURER_EVOLUTION', 632);
define('STRANGE_EVOLUTION_EVOLUTION', 633);
define('CRAB_CLAW_EVOLUTION', 634);
define('UNDEAD_MUMMY_EVOLUTION', 635);
define('FOLLOW_THE_CUBES_EVOLUTION', 636);
define('POISONED_TENTACLES_EVOLUTION', 637);
define('CHEW_PINCH_CATCH_AND_SMACK_EVOLUTION', 638);
