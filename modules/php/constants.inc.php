...
define('ST_MULTIPLAYER_ASK_MINDBUG', 74); // !
...
define('PICK_MONSTER_OPTION', 100);
define('AUTO_SKIP_OPTION', 110);
define('TWO_PLAYERS_VARIANT_OPTION', 120);
