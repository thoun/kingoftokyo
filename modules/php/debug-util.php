...
////////////
    ...
    function debugSetup() {
        ...
        self::DbQuery("UPDATE player SET `player_poison_tokens` = 3 where `player_id` = 2343492");
        self::DbQuery("UPDATE player SET `player_shrink_ray_tokens` = 3 where `player_id` = 2343492");
        ...
        self::DbQuery("UPDATE player SET `player_cultists` = 3 where `player_id` in (2343492, 2343493)");
