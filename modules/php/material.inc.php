...
$this->EVOLUTION_CARDS_TYPES = [
    ...
    611 => 2, 612 => 1, 613 => 1, 614 => 2, 615 => 1, 616 => 1, 617 => 2, 618 => 2, // Gigasnail Hydra
    621 => 2, 622 => 1, 623 => 2, 624 => 1, 625 => 2, 626 => 1, 627 => 2, 628 => 2, // MasterMindbug
    631 => 2, 632 => 1, 633 => 2, 634 => 1, 635 => 2, 636 => 2, 637 => 2, 638 => 2, // Sharky Crab-dog Mummypus-Zilla
];
...
$this->EVOLUTION_TO_PLAY_BEFORE_RESOLVE_DICE_MULTI_OTHERS = [
    MIND_CONTROL_EVOLUTION,
    NEUTRALIZING_LOOK_EVOLUTION,
];

$this->EVOLUTION_TO_PLAY_BEFORE_RESOLVE_DICE = $this->EVOLUTION_TO_PLAY_BEFORE_RESOLVE_DICE_MULTI_OTHERS;

$this->EVOLUTION_TO_PLAY_DURING_RESOLVE_DICE_ACTIVE = [
...
$this->EVOLUTION_TO_PLAY_DURING_RESOLVE_DICE_MULTI_OTHERS = [
    HELPFUL_MINDBUG_EVOLUTION,
];

$this->EVOLUTION_TO_PLAY_DURING_RESOLVE_DICE = array_merge($this->EVOLUTION_TO_PLAY_DURING_RESOLVE_DICE_MULTI_OTHERS, $this->EVOLUTION_TO_PLAY_DURING_RESOLVE_DICE_ACTIVE);
