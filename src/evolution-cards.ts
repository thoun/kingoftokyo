const MONSTERS_WITH_POWER_UP_CARDS = [1,2,3,4,5,6,7,8,/*TODOPUKK 11,*//*TODOPUCT 12,*/13,14,15,18, 61,62,63];
...
class EvolutionCardsManager extends CardManager<EvolutionCard> {
    ...
    private getCardDescription(cardTypeId: number) {
        switch (cardTypeId) {
            ...
            // Gigasnail Hydra
            case 611: case 612: return _("If you reach [Skull], you are not eliminated. Gain 3[Heart], then play with 1 less die for the rest of the game.");
            // 612 same as 611
