...
$stats_type = [
    ...
    "player" => $commonStats + [
        ...
        // TODOAN "dieOfFateEye" => ["id" => 57, "type" => "int", "name" => totranslate("Changed card with die of fate")],
        // TODOAN "dieOfFateRiver" => ["id" => 58, "type" => "int", "name" => totranslate("No effect with die of fate")],
        // TODOAN "dieOfFateSnake" => ["id" => 59, "type" => "int", "name" => totranslate("Snake effect with die of fate")],
        // TODOAN "dieOfFateAnkh" => ["id" => 60, "type" => "int", "name" => totranslate("Ankh effect with die of fate")],
